...
export const errorMessages = {
  ...
  password:
    'A senha precisa ter entre 8 e 16 caracteres, tendo ao menos uma letra e um número',
  confirmPassword: 'As senhas precisam ser iguais',
};
export const errorMessageMinLength =
  'Este campo precisa ter no mínimo 2 caracteres';
